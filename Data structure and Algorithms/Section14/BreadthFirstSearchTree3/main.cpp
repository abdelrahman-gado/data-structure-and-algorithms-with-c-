...
public:
    ...
    std::vector<int> breadthFirstSearch_iterative(Node *root)
    {
    ...
    std::vector<int> breadthFirstSearch_recursive(std::queue<Node *> queue, std::vector<int> bfs_list)
    {
        if (queue.size() == 0)
            return bfs_list;
        ...
        return breadthFirstSearch_recursive(queue, bfs_list);
    }
    
    void inorder (Node *root, std::vector<int> &inorder_list)
    {
        if (root == nullptr)
            return;
    ...
    std::vector<int> dfs_inorder (Node *root, std::vector<int> inorder_list)
    {
        inorder(root, inorder_list);
        return inorder_list;
    }
    
    void preorder (Node *root, std::vector<int> &preorder_list)
    {
        if (root == nullptr)
            return;
        
        preorder_list.push_back(root->data);
        preorder(root->left, preorder_list);
        preorder(root->right, preorder_list);
    }
    
    std::vector<int> dfs_preorder (Node *root, std::vector<int> preorder_list)
    {
        preorder(root, preorder_list);
        return preorder_list;
    }
    
    void postorder (Node *root, std::vector<int> &postorder_list)
    {
        if (root == nullptr)
            return;
        ...
        postorder_list.push_back(root->data);
    }
    
    std::vector<int> dfs_postorder (Node *root, std::vector<int> postorder_list)
    {
